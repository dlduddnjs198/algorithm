...
| 구현 방식                 | 설명 | 예시 링크 |
|-----------------------|------|-----------|
| `Prim_Array.java`     | 배열 기반 단순 구현 (O(V²), 작은 그래프에만 적합) | [✔️ Prim_Array.java](../그래프/Prim_Array.java) |
| `Prim_AdjMatrix.java` | **인접 행렬** 기반, 이론 설명에 좋음 | [✔️ Prim_AdjMatrix.java](../그래프/Prim_AdjMatrix.java) |
| `Prim_PQ.java`        | **우선순위 큐(MinHeap)** 사용 (일반적이고 효율적) | [✔️ Prim_PQ.java](../그래프/Prim_PQ.java) |
